...
class Guitar:
    ...
    def __lt__(self, other):
        """
        Less-than comparison for sorting by year (oldest first).

        :param other: Guitar, the other Guitar to compare to
        :return: bool, True if this guitar's year is less than the other's
        """
        return self.year < other.year  # <-- Added for sorting by year